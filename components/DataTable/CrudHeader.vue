<template>
    <div class="sm:flex sm:items-center">
        ...
        <slot></slot>
        <div v-if="hasCreateNewAction" class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <NuxtLink :to="createNewActionRoute"
    ...
    <div>
        <div v-if="hasSearch" class="mt-3 sm:ml-4 sm:mt-0">
            ...
            <div class="flex rounded-md shadow-sm">
                <div class="relative flex-grow focus-within:z-10">
                    ...
                    <input type="text" name="mobile-search-candidate" id="mobile-search-candidate"
                        ...
                        placeholder="Search">
                    <input @input="$emit('searchInput', ($event.target as HTMLInputElement).value)" v-model="searchInput"
                        type="text" name="desktop-search-candidate" id="desktop-search-candidate"
